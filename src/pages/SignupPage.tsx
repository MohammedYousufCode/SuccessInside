  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/70 via-pink-900/60 to-blue-900/70 backdrop-blur-[2px]" />
      </div>
      ...
      <div className="relative z-10 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-3xl shadow-2xl max-w-md w-full p-8 border border-white/20">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block mb-4">
            {/* Your Custom Success Inside Logo */}
            <img
              src="/logo.png"
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2 font-medium">Start your transformation today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-500/50 focus:border-purple-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white disabled:opacity-50 transition-all"
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loading}
                className="w-full px-4 py-3 pr-12 border-2 border-gray-300 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-500/50 focus:border-purple-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white disabled:opacity-50 transition-all"
                required
                minLength={6}
              />
              <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white rounded-xl font-bold text-lg hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-xl hover:shadow-2xl hover:scale-105 transform"
          >
            {loading ? (
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          <p className="text-xs text-center text-gray-500 dark:text-gray-500">
            🏔️ Reach new heights with consistent habits
          </p>
        </div>
      </div>
    </div>
